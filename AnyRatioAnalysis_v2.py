...
def _calcAppendRatios(singleDf, allBelowOne = False, isotopeList = ['13C','15N','UnSub']):
    '''
...
def _combineSubstituted(peakDF,cullOn = None, cullAmount = 3, isotopeList = ['13C','15N','UnSub']):
    '''
